...
GLOVE_PATH = os.path.join(EMBEDDINGS_PATH, "glove.6B.300d.txt")
GOOGLE_PATH = os.path.join(EMBEDDINGS_PATH, "GoogleNews-vectors-negative300.bin")
FASTTEXT_PATH = os.path.join(EMBEDDINGS_PATH, "wiki-news-300d-1M-subword.vec")
